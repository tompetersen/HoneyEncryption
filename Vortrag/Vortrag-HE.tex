...
\input{2-Beispiel.tex}

\input{3-DTE.tex}

\input{4-Verschluesselung.tex}

\input{5-ProblemeAnwendungen.tex}
...
\begin{frame}
	...
	\begin{center}
		\includegraphics[width=0.8\textwidth]{pic/svs_logo_hires-ohne-was.png}
	\end{center}
\end{frame}
...
\begin{frame}
	...
	\vspace{\fill}
	\begin{center}
		\includegraphics[width=\textwidth]{pic/svs_logo_hires-ohne-was.png}
	\end{center}
\end{frame}
